...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = Constants.fl;
    public static String leftRearMotorName = Constants.bl;
    public static String rightFrontMotorName = Constants.fr;
    public static String rightRearMotorName = Constants.br;

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 78.4723;
    private static double yMovement = 57.449;
    ...
    public static double centripetalScaling = .0000000000000001;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -27.1174;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -65.81;
    ...
    // This can be custom set for each Path.
    public static double pathEndTimeoutConstraint = 400;
