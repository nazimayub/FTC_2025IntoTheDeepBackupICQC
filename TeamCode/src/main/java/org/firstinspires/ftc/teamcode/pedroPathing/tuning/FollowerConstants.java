...
public class FollowerConstants {
    ...
    private static double xMovement = 80.434;
    private static double yMovement = 60.0454;
    ...
    public static double centripetalScaling = 0.000000000000000000000001;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = 75.7408;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -56.3665;
