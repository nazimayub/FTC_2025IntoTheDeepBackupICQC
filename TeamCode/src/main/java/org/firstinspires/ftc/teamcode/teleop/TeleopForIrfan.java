...
public class TeleopForIrfan extends CommandOpMode {
    ...
    public void initialize() {
        ...
        slide = new PIDFSlideSubsystem(hardwareMap, Constants.rSlide, Constants.lSlide, DcMotorSimple.Direction.FORWARD, DcMotorSimple.Direction.REVERSE, 0.04, 0, 0.005, 0.01, 0.04, 0, 0.005, 0.01);
