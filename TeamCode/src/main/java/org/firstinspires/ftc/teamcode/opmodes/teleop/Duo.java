...
public class Duo extends CommandOpMode {
    ...
    public void initialize() {
        ...
        new GamepadButton(base, GamepadKeys.Button.B).whenPressed(new SequentialCommandGroup(
                ...
                new SetPIDFSlideArmCommand(slide, 15000), // CHANGE THIS IRFAAAAAAAAN
        ...
        new GamepadButton(op, GamepadKeys.Button.Y).whenPressed(new SequentialCommandGroup(
