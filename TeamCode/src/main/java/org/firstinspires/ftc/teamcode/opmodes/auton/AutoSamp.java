...
public class AutoSamp extends OpMode {
    ...
    public void init() {
        ...
        intake = new IntakeAutoSubsystem(hardwareMap, Const.intake);
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        new FollowPathCommand(follower, scorePreload.getPath(0),3000),
                        ...
                        new FollowPathCommand(follower, rotToSamps.getPath(0), 3000),
                        ...
                        new IntakeAutoCommand(intake, -1, 4)
                )
        );
    }
    ...
    public void path() {
        ...
        rotToSamps = follower.pathBuilder()
