...
public class RobotValues {
    ...
    public static DcMotorEx.Direction LEFTDIR = DcMotorEx.Direction.REVERSE;
    public static DcMotorEx.Direction RIGHTDIR = DcMotorEx.Direction.FORWARD;
    ...
    public static DcMotorEx.RunMode POSITION = DcMotorEx.RunMode.RUN_TO_POSITION;
